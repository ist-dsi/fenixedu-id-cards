<template>
  ...
  >
    ...
    <span
      ...
      class="label label--sm id-card__label label--primary"
    >{{ $t(`id-card.states.${visualCardStates[cardState].toLowerCase()}`) }}</span>
    <img
...
.id-card {
  ...
  box-shadow: 0 0.625rem 1.25rem 0 rgba(black, 0.2);
