...
<%@page import="org.fenixedu.idcards.domain.CardGenerationEntry"%>
<%@page import="org.fenixedu.idcards.domain.CardGenerationBatch"%>
...
<logic:present name="person">
	...
	<table class="tstyle1 thlight thtop mtop05">
	  	<tbody>
	  		<tr>
	    		<th scope="row" class="acenter">
	      			<bean:message key="label.person.name" bundle="APPLICATION_RESOURCES"/>
	    		</th>
	    		<td class="acenter">
	      			${person.name}
	    		</td>
			</tr>
			<tr class="bgcolorfafafa">
			    <th scope="row" class="acenter">
	  		...
	  		<tr>
			    <th scope="row" class="acenter">
	      			<bean:message key="label.person.username" bundle="APPLICATION_RESOURCES"/>
			    </th>
			    <td class="acenter">
	      			${person.username}
			    </td>
	  		...
	  		<tr class="bgcolorfafafa">
	    		<th scope="row" class="acenter">
	      			<bean:message key="label.net.sourceforge.fenixedu.domain.Person.documentIdNumber" bundle="APPLICATION_RESOURCES"/>
	    		</th>
	    		<td class="acenter">
	      			${person.documentIdNumber}
			    </td>
	  		</tr>
	  		<tr class="bgcolorfafafa">
	    		<th scope="row" class="acenter">
	      			<bean:message key="label.numberOfCardGenerationEntries" bundle="CARD_GENERATION_RESOURCES"/>
	    		</th>
	    		<td class="acenter">
	      			${person.cardGenerationEntriesSet.size()}
	    		</td>
	  		</tr>
		</tbody>
	</table>
